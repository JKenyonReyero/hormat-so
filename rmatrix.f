...
c      print*, nch,lval,qk,eta,rmax,nr,ns !,cpot,cu,
c     1 ncp1,ndim,nopen,twf,cf,nwf1,nwf2,nc,nvc,ncp2,cpnl
c      read*
     ...
     1 cop(nch),cz(nch,nch),crma2(nch,nch,ns),
     2 crma0(nch,nch,0:ns),cfp(nch,0:ns),xc(nch,2),npo(nch,2))
      nopen=0
      nclo=0
      cu=0
      cfp=0
